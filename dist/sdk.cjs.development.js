...
var ROUTER_ADDRESSES = (_ROUTER_ADDRESSES = {}, _ROUTER_ADDRESSES[exports.ChainId.MAINNET] = "0xcd7d16fB918511BF7269eC4f48d61D79Fb26f918", _ROUTER_ADDRESSES[exports.ChainId.TESTNET] = "0x989dBb40f0B8a431e9D79dfd28fdC3df3717D9c0", _ROUTER_ADDRESSES);
var FACTORY_ADDRESSES = (_FACTORY_ADDRESSES = {}, _FACTORY_ADDRESSES[exports.ChainId.MAINNET] = "0x73A48f8f521EB31c55c0e1274dB0898dE599Cb11", _FACTORY_ADDRESSES[exports.ChainId.TESTNET] = "0x004615D9cCab58bDE10877BE03F053c94599F3ce", _FACTORY_ADDRESSES);
var INIT_CODE_HASHES = (_INIT_CODE_HASHES = {}, _INIT_CODE_HASHES[exports.ChainId.MAINNET] = "0xc93158cffa5b575e32566e81e847754ce517f8fa988d3e25cf346d916216e06f", _INIT_CODE_HASHES[exports.ChainId.TESTNET] = "0xc93158cffa5b575e32566e81e847754ce517f8fa988d3e25cf346d916216e06f", _INIT_CODE_HASHES);
...
var VVSPair = /*#__PURE__*/function () {
  ...
  VVSPair.getAddress = function getAddress(tokenA, tokenB) {
    ...
    if (((_VVS_PAIR_ADDRESS_CAC = VVS_PAIR_ADDRESS_CACHE) === null || _VVS_PAIR_ADDRESS_CAC === void 0 ? void 0 : (_VVS_PAIR_ADDRESS_CAC2 = _VVS_PAIR_ADDRESS_CAC[tokens[0].address]) === null || _VVS_PAIR_ADDRESS_CAC2 === void 0 ? void 0 : _VVS_PAIR_ADDRESS_CAC2[tokens[1].address]) === undefined) {
      ...
      VVS_PAIR_ADDRESS_CACHE = _extends({}, VVS_PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_VVS_PAIR_ADDRESS_CAC3 = VVS_PAIR_ADDRESS_CACHE) === null || _VVS_PAIR_ADDRESS_CAC3 === void 0 ? void 0 : _VVS_PAIR_ADDRESS_CAC3[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = address.getCreate2Address('0x3b44b2a187a7b3824131f8db5a74194d0a42fc15', solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), '0xa77ee1cc0f39570ddde947459e293d7ebc2c30ff4e8fc45860afdcb2c2d3dc17'), _extends2)), _extends3));
    }
