...
var _ROUTER_ADDRESSES, _FACTORY_ADDRESSES, _INIT_CODE_HASHES, _SOLIDITY_TYPE_MAXIMA;
var ChainId;
...
var ROUTER_ADDRESSES = (_ROUTER_ADDRESSES = {}, _ROUTER_ADDRESSES[ChainId.MAINNET] = "0x145677FC4d9b8F19B5D56d1820c48e0443049a30", _ROUTER_ADDRESSES[ChainId.TESTNET] = "0x989dBb40f0B8a431e9D79dfd28fdC3df3717D9c0", _ROUTER_ADDRESSES);
var FACTORY_ADDRESSES = (_FACTORY_ADDRESSES = {}, _FACTORY_ADDRESSES[ChainId.MAINNET] = "0xd590cC180601AEcD6eeADD9B7f2B7611519544f4", _FACTORY_ADDRESSES[ChainId.TESTNET] = "0x004615D9cCab58bDE10877BE03F053c94599F3ce", _FACTORY_ADDRESSES);
var INIT_CODE_HASHES = (_INIT_CODE_HASHES = {}, _INIT_CODE_HASHES[ChainId.MAINNET] = "0x7ae6954210575e79ea2402d23bc6a59c4146a6e6296118aa8b99c747afec8acf", _INIT_CODE_HASHES[ChainId.TESTNET] = "0x7ae6954210575e79ea2402d23bc6a59c4146a6e6296118aa8b99c747afec8acf", _INIT_CODE_HASHES);
...
var VVS_PAIR_ADDRESS_CACHE = {};
var VVSPair = /*#__PURE__*/function () {
  function VVSPair(tokenAmountA, tokenAmountB) {
    var tokenAmounts = tokenAmountA.token.sortsBefore(tokenAmountB.token) // does safety checks
    ? [tokenAmountA, tokenAmountB] : [tokenAmountB, tokenAmountA];
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, VVSPair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'VVS-LP', 'VVS LPs');
    this.tokenAmounts = tokenAmounts;
  }

  VVSPair.getAddress = function getAddress(tokenA, tokenB) {
    var _VVS_PAIR_ADDRESS_CAC, _VVS_PAIR_ADDRESS_CAC2;

    var tokens = tokenA.sortsBefore(tokenB) ? [tokenA, tokenB] : [tokenB, tokenA]; // does safety checks

    if (((_VVS_PAIR_ADDRESS_CAC = VVS_PAIR_ADDRESS_CACHE) === null || _VVS_PAIR_ADDRESS_CAC === void 0 ? void 0 : (_VVS_PAIR_ADDRESS_CAC2 = _VVS_PAIR_ADDRESS_CAC[tokens[0].address]) === null || _VVS_PAIR_ADDRESS_CAC2 === void 0 ? void 0 : _VVS_PAIR_ADDRESS_CAC2[tokens[1].address]) === undefined) {
      var _VVS_PAIR_ADDRESS_CAC3, _extends2, _extends3;

      VVS_PAIR_ADDRESS_CACHE = _extends({}, VVS_PAIR_ADDRESS_CACHE, (_extends3 = {}, _extends3[tokens[0].address] = _extends({}, (_VVS_PAIR_ADDRESS_CAC3 = VVS_PAIR_ADDRESS_CACHE) === null || _VVS_PAIR_ADDRESS_CAC3 === void 0 ? void 0 : _VVS_PAIR_ADDRESS_CAC3[tokens[0].address], (_extends2 = {}, _extends2[tokens[1].address] = getCreate2Address('0x3b44b2a187a7b3824131f8db5a74194d0a42fc15', keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), '0xa77ee1cc0f39570ddde947459e293d7ebc2c30ff4e8fc45860afdcb2c2d3dc17'), _extends2)), _extends3));
    }

    return VVS_PAIR_ADDRESS_CACHE[tokens[0].address][tokens[1].address];
  }
  /**
   * Returns true if the token is either token0 or token1
   * @param token to check
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    return [outputAmount, new VVSPair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))];
  };
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    var denominator = JSBI.multiply(JSBI.subtract(outputReserve.raw, outputAmount.raw), FEES_NUMERATOR);
    var inputAmount = new TokenAmount(outputAmount.token.equals(this.token0) ? this.token1 : this.token0, JSBI.add(JSBI.divide(numerator, denominator), ONE));
    return [inputAmount, new VVSPair(inputReserve.add(inputAmount), outputReserve.subtract(outputAmount))];
  };
